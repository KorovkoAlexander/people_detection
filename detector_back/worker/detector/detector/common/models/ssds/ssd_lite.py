...
from detector.train.losses.l2norm import L2Norm
...
# https://github.com/tensorflow/models/blob/master/research/object_detection/models/feature_map_generators.py#L213
# when the expand_ratio is 1,
# the implemetation is nearly same.
# Since the shape is always change,
# I do not add the shortcut as what mobilenetv2 did.
