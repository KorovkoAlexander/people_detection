...
NTECHLAB_CLASSES = ('__background__', 'person')

# for making bounding boxes pretty
COLORS = ((255, 0, 0, 128), (0, 255, 0, 128))


class NTechLabDetection(data.Dataset):
    ...
    def pull_image(self, index):
        filename = self.table.iloc[index]["image_name"]
    ...
    def pull_bbox(self, index):
        target = np.array(literal_eval(self.table.iloc[index].bboxes))[:,:4]
        # add sintetic labels
